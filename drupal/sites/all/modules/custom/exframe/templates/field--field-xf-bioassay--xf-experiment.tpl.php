...
<div class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <thead>
  <tr class="xf-thead">
    <th class="exframe-cell exframe-expand-row">
    </th>
    <th class="exframe-cell exframe-name">
      Name
    </th>
    <th class="exframe-cell exframe-organism">
      Organism
    </th>
  ...
  <div class="exframe-analyze-link">
    <div class="exframe-analyze-description"> Please Note: analysis tools are currently under development.</div>
    <div class ="exframe-button">
      <?php print $analyze_link; ?>
    </div>
  </div>
</div>
